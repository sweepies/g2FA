...
function getResponse() {
    ...
    // Verify OTP
    $twofactorResponse = $twofactor->verify($data->steamid64, $data->otp, $data->remember_on_device, get_client_ip());
    ...
    http_response_code($twofactorResponse["httpCode"]);
    return array("last_auth_timestamp" => $twofactorResponse["last_auth_timestamp"]);
}
